<footer class="footer">
			...
			<div class="grid__row">
				...
				<div class="col l-2-4 m-8 c-6">
					...
					<div class="footer__download">
						<img src="<?php echo $config['url'] ?>/public/img/qrcode.png" class="footer__download-qr">
						<div class="footer__download-apps">
							<a href="#" class="footer__download-app-link">
								<img src="<?php echo $config['url'] ?>/public/img/ch_play.png" class="footer__download-app-img">
							</a>

							<a href="#" class="footer__download-app-link">
								<img src="<?php echo $config['url'] ?>/public/img/apstore.png" class="footer__download-app-img">
							</a>
						</div>
					</div>
		...
		<div class="footer__bottom">
			<div class="grid wide">
				<p class="footer__text">@2021 - Bản quyền thuộc về Nhóm L09 - Lập trình web</p>
			</div>
		</div>
	</footer>